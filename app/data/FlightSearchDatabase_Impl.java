        ...
        final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
            ...
            public RoomOpenHelper.ValidationResult onValidateSchema(
                ...
                if (!_infoAirport.equals(_existingAirport)) {
                    return new RoomOpenHelper.ValidationResult(false, "airport(com.entropia.flightsearch.data.Airport).\n"
                            + " Expected:\n" + _infoAirport + "\n"
                            + " Found:\n" + _existingAirport);
                }
                ...
                if (!_infoFavorite.equals(_existingFavorite)) {
                    return new RoomOpenHelper.ValidationResult(false, "favorite(com.entropia.flightsearch.data.Favorite).\n"
                            + " Expected:\n" + _infoFavorite + "\n"
                            + " Found:\n" + _existingFavorite);
                }
